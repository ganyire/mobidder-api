...
<blockquote><?php echo e(__("scribe::example_request")); ?>:</blockquote>
...
<?php if($endpoint->isGet() || $endpoint->hasResponses()): ?>
    <?php $__currentLoopData = $endpoint->responses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <blockquote>
            <p><?php echo e(__("scribe::example_response")); ?> (<?php echo e($response->fullDescription()); ?>):</p>
        </blockquote>
...
<code><?php echo __("scribe::example_response.binary"); ?> - <?php echo e(htmlentities(str_replace("<<binary>>", "", $response->content))); ?></code>
<?php elseif($response->status == 204): ?>
<code><?php echo __("scribe::example_response.empty"); ?></code>
<?php else: ?>
...
<span id="execution-results-<?php echo e($endpoint->endpointId()); ?>" hidden>
    <blockquote><?php echo e(__("scribe::try_it_out.received_response")); ?><span
    ...
    <pre class="json"><code id="execution-response-content-<?php echo e($endpoint->endpointId()); ?>"
      data-empty-response-text="<<?php echo e(__("scribe::example_response.empty")); ?>>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-<?php echo e($endpoint->endpointId()); ?>" hidden>
    <blockquote><?php echo e(__("scribe::try_it_out.request_failed")); ?>:</blockquote>
...
<form id="form-<?php echo e($endpoint->endpointId()); ?>" data-method="<?php echo e($endpoint->httpMethods[0]); ?>"
    ...
    <h3>
        <?php echo e(__("scribe::endpoint.request")); ?>&nbsp;&nbsp;&nbsp;
        <?php if($metadata['try_it_out']['enabled'] ?? false): ?>
            <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-<?php echo e($endpoint->endpointId()); ?>"
                    onclick="tryItOut('<?php echo e($endpoint->endpointId()); ?>');"><?php echo e(__("scribe::try_it_out.open")); ?>

            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-<?php echo e($endpoint->endpointId()); ?>"
                    onclick="cancelTryOut('<?php echo e($endpoint->endpointId()); ?>');" hidden><?php echo e(__("scribe::try_it_out.cancel")); ?>

            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-<?php echo e($endpoint->endpointId()); ?>"
                    data-initial-text="<?php echo e(__("scribe::try_it_out.send")); ?>"
                    data-loading-text="<?php echo e(__("scribe::try_it_out.loading")); ?>"
                    hidden><?php echo e(__("scribe::try_it_out.send")); ?>
    ...
    <?php if(count($endpoint->headers)): ?>
        <h4 class="fancy-heading-panel"><b><?php echo e(__("scribe::endpoint.headers")); ?></b></h4>
    ...
    <?php if(count($endpoint->urlParameters)): ?>
        <h4 class="fancy-heading-panel"><b><?php echo e(__("scribe::endpoint.url_parameters")); ?></b></h4>
    ...
    <?php if(count($endpoint->queryParameters)): ?>
        <h4 class="fancy-heading-panel"><b><?php echo e(__("scribe::endpoint.query_parameters")); ?></b></h4>
    ...
    <?php if(count($endpoint->nestedBodyParameters)): ?>
        <h4 class="fancy-heading-panel"><b><?php echo e(__("scribe::endpoint.body_parameters")); ?></b></h4>
...
<?php if(count($endpoint->responseFields)): ?>
    <h3><?php echo e(__("scribe::endpoint.response")); ?></h3>
    <h4 class="fancy-heading-panel"><b><?php echo e(__("scribe::endpoint.response_fields")); ?></b></h4>
    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/html/server-bid-app/vendor/knuckleswtf/scribe/src/../resources/views//themes/default/endpoint.blade.php ENDPATH**/ ?>