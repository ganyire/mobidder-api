...
<div class="tocify-wrapper">
    ...
    <div class="search">
        <input type="text" class="search" id="input-search" placeholder="<?php echo e(__("scribe::search")); ?>">
    </div>
    ...
    <ul class="toc-footer" id="toc-footer">
        <?php if($metadata['postman_collection_url']): ?>
            <li style="padding-bottom: 5px;"><a href="<?php echo $metadata['postman_collection_url']; ?>"><?php echo __("scribe::links.postman"); ?></a></li>
        <?php endif; ?>
        <?php if($metadata['openapi_spec_url']): ?>
            <li style="padding-bottom: 5px;"><a href="<?php echo $metadata['openapi_spec_url']; ?>"><?php echo __("scribe::links.openapi"); ?></a></li>
        <?php endif; ?>
...
<?php /**PATH /var/www/html/server-bid-app/vendor/knuckleswtf/scribe/src/../resources/views//themes/default/sidebar.blade.php ENDPATH**/ ?>